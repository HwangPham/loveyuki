...
export default function Surprise() {
  ...
  const surpriseText = "On this Valentine’s Day, just like every day, all I have is my love for you.";
  const text = " Though the distance separates us and time keeps us going on our own way, every day I will hold in my heart the care and blessing for you and I will never let you go.";
                ...
                >
                  <div className="relative mx-auto max-w-md rounded-2xl overflow-hidden shadow-2xl">
                    ...
                    <motion.div
                      ...
                      className="absolute -inset-1 bg-gradient-to-r from-pink-400 via-rose-400 to-purple-400 rounded-2xl blur-lg"
                    />
                    
                    {/* Image container */}
                    <div className="relative bg-white p-2 rounded-2xl">
                      <img
                        src="https://res.cloudinary.com/dwj5uy707/image/upload/v1771085288/z7535298923091_bbc4346aa94436951571bfce7b861fcb_uxb6jn.jpg"
                        alt="Special moment"
                    ...
                    <motion.div
                      ...
                      transition={{ duration: 2, repeat: Infinity }}
                      className="absolute -top-3 -right-3 bg-pink-500 rounded-full p-2 shadow-lg"
                    >
